...
public class Inventory : MonoBehaviour {
	...
	void Start ()
	{
        ...
        PlayerChara = GetComponent<CharacterStatistics>();
        //weapon_init = GameObject.Find("InitWeapon");
        if(PlayerChara.name == "Swayne The Rock")
        {
            Item AKM = PlayerShooting.getChildGameObject(weapon_init, "AKM").GetComponent<Item>();
            this.Add(AKM, 1);
        }else //Gara
        {
           /* Item Katana = PlayerShooting.getChildGameObject(weapon_init, "Katana").GetComponent<Item>();
            this.Add(Katana, 1);*/
        }
	}
    ...
    public CharacterStatistics PlayerChara;
